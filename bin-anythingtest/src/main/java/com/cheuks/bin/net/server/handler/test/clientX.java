...
public class clientX {
			...
			executorService.submit(new Runnable() {
				public void run() {
					try {
						...
						// System.err.println("运行时间:" + (new Date().getTime() -
						// now.getTime()) + "ms " + ser.a());
	...
	// static {
	// com.cheuks.bin.net.server.handler.test.ServiceHandlerTest2$MC_IMPL o =
	// null;
	// o = (com.cheuks.bin.net.server.handler.test.ServiceHandlerTest2$MC_IMPL)
	// super.clone();
	// o.callMethod =
	// (com.cheuks.bin.net.server.handler.test.ServiceHandlerTest2$MC_IMPL)
	// o.com.cheuks.bin.net.server.handler.CallMethod.clone();
	// return o;
	// }
