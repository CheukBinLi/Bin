...
import com.cheuks.bin.anythingtest.reference.T3.SoftNode;

public class T3<K, V> extends ConcurrentHashMap<K, SoftNode<K, V>> {
	...
	private void checkValues() {
		for (Object x; (x = queue.poll()) != null;) {
			synchronized (queue) {
				...
				Node<K, V> n = o.get();
				System.err.println(get(o.getHash()));
